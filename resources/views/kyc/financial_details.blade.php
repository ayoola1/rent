                     ...
                     {{--  <div class="box"> --}}
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-6">
                                ...
                                <form action="{{route('financialupdate',$user->id)}}" method="post" enctype="multipart/form-data">
                                  
                                  @csrf

                                  <input type="hidden" value="PUT" name="_method">
                                  <div class="form-group">
                                     <label for="name">Company | Employer's Name:</label>
                                     <input type="text" class="form-control" value="{{$user->emp_name}}" name="emp_name" >
                                  </div>

                                   <div class="form-group">
                                      <label for="name">Employer's Address:</label>
                                       <input type="text" name="emp_add" value="{{$user->emp_add}}" class="form-control" >
                                  </div>

                                  <div class="form-group">
                                     <label for="name">Bvn Number:</label>
                                      <input type="text" name="bvn" value="{{$user->bvn}}" class="form-control">
                                  </div>

                                  <div class="form-group">
                                     <label for="name">Upload Bank Statement:</label>
