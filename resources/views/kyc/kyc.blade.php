...
<section class="our-log bgc-fa" style="margin-bottom: 70px; margin-top: 120px;">
    <div class="container">
      <div class="row">
           ...
           <p style="margin-top: 20px;position:relative; left: 550px;">Update your Details:</p>
         
       <form action="{{route('kyc.update',Auth::user()->id)}}" method="post">
        ...
        @csrf
          <div class="row" style="margin-top: 40px;">
             ...
             <div class="col-md-4">
               ...
               <div class="col-md-4">
                 <label for="name">Employer's Address:</label>
                   <div class="form-group">
                      <input type="text" name="emp_add" class="form-control" required="">
                   </div>
               </div>
            ...
            <div class="col-md-12">
                <button type="submit" class="btn btn-info" style="margin-left: -13px;">Save</button>
            </div>
        </form>
