            ...
            <div class="col-lg-7">
               <div class="middle-section text-center">
                <div class="section-width">
                  <h2 style="color: #000;">Smart Way to Rent2Use <br>and Rent2Own <br> a Home in Africa</h2>
                  <p style="color: #000; font-size: 16px">RentGage helps simplify acquisition of home via Mortgage
and help you pay your rent conveniently monthly.
</p>
            ...
            <form action="#" class="w3l-cover-3-gd intform" method="GET">
             ...
             <div class="col-lg-5 mt-5">
              <img src="assets/images/mortgage-house.png" class="img-fluid" alt="" style="margin-top: 30px;">
            </div>
...
<section class="w3l-index3" id="about" >
    <div class="midd-w3 pb-5">
        <div class="container pb-lg-5 pb-md-4 pb-2">
            <div class="heading text-center mx-auto">
                <h3 class="title-big" style="margin-bottom: 20px">Rentgage Advantage</h3>
            </div>
            <div class="row" style="margin-top: 20px;" style="background-color: #f7f7f7;">
               <div class="col-lg-7 pl-lg-0">
                    <div class="w3l-right-info">
                        {{-- <h6 class="title-small">Who we are</h6> --}}
                        <h3 class="title-big">We Match your Rent With the Way You Earn</h3>
                        <p>Whether You want to Rent to Own or You looking to Rent a Home for Use – Now You can Pay Your Rent/Mortgage Monthly or even Weekly.
                        </p>
                        
                        <a href="#" class="btn btn-style btn-primary mt-4">Apply Now</a>
                    </div>
                </div>
           ...
           {{--  <div class="heading text-center mx-auto">
            ...
            <div class="row" style="margin-top: 20px;">
               ...
               <div class="col-lg-7 pl-lg-0">
                        ...
                        {{-- <h6 class="title-small">Who we are</h6> --}}
                        <h3 style="text-align: right;" class="title-big">Smart Landlord Partner with Us</h3>
                        <h4 style="font-weight: 700; color:#484848; font-size: 18px; text-align: right;">Are You’re a Property Owner?</h4>
                        <p style="text-align: right;" class="mt-4">Join the Community hundreds of Smart Landlord who <br> have partner with us to ensure Easy Rent Payment and Always on time.
                        </p>
                        
                        <a  style="margin-left: 470px;" href="#" class="btn btn-style btn-primary mt-4">List Your Property</a>
           ...
           {{--  <div class="heading text-center mx-auto">
            ...
            <div class="row" style="margin-top: 20px;" style="background-color: #f7f7f7;">
              ...
              <div class="col-lg-7 pl-lg-0">
                        ...
                        {{-- <h6 class="title-small">Who we are</h6> --}}
                        <h3 class="title-big">Become Finance Partner - Sponsor a Rent Payment</h3>
                        <p class="mt-4">Help pay Rent and we reward handsomely – Earn up to 30%<br> ROI, helping people pay their full rent upfront.<br> Real Estate Investment is the most secure investment.
                        </p>
                        
                        <a  href="#" class="btn btn-style btn-primary mt-4">Invest Now</a>
                    
                </div>

               <div class="col-lg-5 pr-lg-0">
                    <div class="w3l-lefttt-img">
                    </div>
                    {{-- <img src="assets/images/image006.png" alt=""> --}}
                </div>
            ...
            <div class="row" style="margin-top: 20px; margin-bottom: 60px;">
               ...
               <div class="col-lg-5 pr-lg-0">
                ...
                <div class="col-lg-7 pl-lg-0">
                        ...
                        {{-- <h6 class="title-small">Who we are</h6> --}}
                        <h3 style="text-align: right;" class="title-big">We Take Security Seriously – Your Money is Secure.</h3>
                        <p style="text-align: right;" class="mt-4">RentGage is secured with the highest level of internet security to protect your data. Your savings are held with firms that are regulated by the Central Bank of Nigeria (CBN) and insured by Nigeria deposit insurance scheme (NDIC).
                        </p>
