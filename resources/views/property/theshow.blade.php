            ...
            <div class="col-xl-8 col-lg-7">
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                   ...
                   <form action="{{route('updatepropTent',$property->id)}}" method="post" enctype="multipart/form-data">
                    ...
                    @csrf
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6">
                              ...
                              <input type="text" class="form-control" value="{{$property->price}}" name="price" readonly="">
                         </div>

                          <div class="col-md-6">
                             <label for="name">Address:</label>
                              <input type="text" class="form-control" value="{{$property->address}}" name="address" readonly="">
                          </div>
                       ...
                       <div class="row">
                        ...
                        <div class="col-md-6">
                             ...
                             <input type="text" class="form-control" value="{{$property->bed}}" name="bed" readonly="">
                        </div>

                          <div class="col-md-6">
                             <label for="name">Property Type:</label>
                              <input type="text" class="form-control" value="{{$property->type->name}}"  readonly="">
                                <input type="hidden" class="form-control" value="{{$property->type_id}}"  name="type_id">
                          </div>
                       ...
                       <div class="row">
                         ...
                         <div class="col-md-6">
                            <label for="name">Landlord:</label>
                             <input type="text" class="form-control" value="{{$property->landlord->user->name}}" readonly="">
                              <input type="hidden" class="form-control" value="{{$property->landlord_id}}"  name="landlord_id">
                         </div>
                          ...
                          <div class="form-group">
                              <input type="submit" class="btn btn-success" value="update" style="margin-top: 30px; ">
                          </div> 
