              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-body">
                  @include('includes.success_message')
                   ...
                   <p style="font-size: 24px;font-weight: 600;text-align: center;">&#8358;0.00</p>
                     ...
                     <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                              <input type="text" name="deposit" id="txt_name" class="form-control" placeholder="Enter Amount" required="" style="margin-left: 190px;">
                       ...
                       <div class="row"> 
                         <div class="col-md-12"> 
                            <div class="form-group ">
                                 ...
                                 <button type="submit" style="margin-left: 285px;" class="btn btn-success" > Fund Wallet </button>
